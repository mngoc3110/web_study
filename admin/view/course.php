...
$sql = "SELECT id,name, description, cost, avatar,public,teacher_id FROM course_db";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class='button-container'>
                        <button class='button'>Sửa</button>
                         <form action='./assets/php/deletecourse.php' method='POST'>
                            <input type='hidden' name='id' value='" . $row['id'] . "' />
                            <button class='button' type='submit'>Xóa</button>
                        </form>
                        <form action='./assets/php/publiccourse.php' method='POST'>
                            <input type='hidden' name='id' value='" . $row['id'] . "' /> 
                            <label class='switch'>
